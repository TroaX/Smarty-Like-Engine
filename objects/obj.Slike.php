<?php
 $SLikeEngine = new Class() {
    ...
    private $HTTPEquiv = array("charset"=>"utf-8","expires"=>"0");
    private $HTTPKeys = array("language","expires");
    private $MetaTags = array("revisit-after"=>"1 month");
    private $MetaKeys = array("description","keywords","robots","author","date","publisher","copyright","page-topic","audience","revisit-after");
    ...
    public function ShowTemplate(string $TemplateFile, string $PageContent, array $Data) :bool {
        ...
        $OutputFile = $this->CompiledPath.str_replace(array("/","\\"),"_",$TemplateFile).".php";
